...
%>
    ...
    <sql:query var="listbadclient"   dataSource="${myDS}">
      SELECT c.FirstName,c.Lastname -- 8
FROM Bill b
...
WHERE b.Status = 'pending' and b.Status = 'in progress'  AND CURRENT_DATE > DATE_ADD(b.DueDate, INTERVAL 1 WEEK);
 </sql:query>
     <div class="topnav">
...
<div class="bg-text">
    <div align="center">
        <table border="1" cellpadding="5">
           <h2>Clients Who that have never paid any bill after it is due</h2>
            <tr>
            <th>S.No</th>
                <th>Client Name</th>
